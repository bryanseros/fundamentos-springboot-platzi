...
import com.fundamenosplatzi.springboot.fundamentos.dto.UserDTO;
...
public interface UserRepository extends PagingAndSortingRepository<User, Long> {
    ...
    @Query("SELECT new com.fundamenosplatzi.springboot.fundamentos.dto.UserDTO(u.id, u.name, u.birthday)" +
    " FROM User u" +
